...
public class TElectricVehicleWithLine extends Model<TElectricVehicleWithLine> {
    ...
    public List<TLine> gettLines() {
        return tLines;
    }

    public void settLines(List<TLine> tLines) {
        this.tLines = tLines;
    }
