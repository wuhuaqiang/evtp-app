...
public class HttpClientUtils {
     ...
     * @return
     */
    public static HttpClientResult doPostInfo(String baseUrl,String parameters,String sessionId) {
        ...
        if (postmethod != null ) {
            try {
                ...
                postmethod.setHeader("Cookie", "JSESSIONID=" + sessionId);
        ...
        return new HttpClientResult(response.getStatusLine().getStatusCode(), bodyString);
    }
