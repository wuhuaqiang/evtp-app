...
public class WebSecurityConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("*")
                .allowedOrigins("http://10.168.1.185:1101")
                .allowedOrigins("http://10.168.1.185:10200")
                .allowedOrigins("http://10.168.1.185:2008")
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        addInterceptor.excludePathPatterns("/common/logon**");
        addInterceptor.excludePathPatterns("/common/register**");
        addInterceptor.excludePathPatterns("/fabricConfig/list**");
        addInterceptor.excludePathPatterns("/chaincode/**");
        addInterceptor.excludePathPatterns("/chainblock/**");
        addInterceptor.excludePathPatterns("/chainchannel/**");
