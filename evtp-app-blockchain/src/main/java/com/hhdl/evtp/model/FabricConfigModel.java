...
public class FabricConfigModel {
    ...
    private String ca_location; //ca服务器地址
    private String ca_name; //ca服务器名称
    ...
    public boolean isIs_tls() {
        return is_tls;
    }

    public boolean isIs_catls() {
        return is_catls;
    }
    ...
    public String getCa_location() {
        return ca_location;
    }

    public void setCa_location(String ca_location) {
        this.ca_location = ca_location;
    }
