package com.hhdl.evtp.sdk;

import com.hhdl.evtp.dao.FabricConfigMapper;
import com.hhdl.evtp.fabric.sdkinterface.SdkInterfaceOrg;
...
//        }
//        return instance;
        return new SdkManager(fabricConfigMapper);
    }
    ...
    public void setOrgCfgFromDb() {
        ...
        if (configList != null && configList.size() > 0) {
            ...
            List<FabricConfigOrdererModel> configOrdererList = fabricConfigMapper.queryFabricOrderer(configData.getLeague_id());
            List<FabricConfigPeerModel> configPeerList = fabricConfigMapper.queryFabricPeer(configData.getLeague_id());

            this.sdkInterfaceOrg.setOrgName(configData.getOrg_name());
            this.sdkInterfaceOrg.setCaLocation(configData.getCa_location());
            this.sdkInterfaceOrg.setCaName(configData.getCa_name());
            this.sdkInterfaceOrg.setUsername(configData.getUser_name());
            this.sdkInterfaceOrg.setUsername(userModel.getAccount());
            this.sdkInterfaceOrg.setPassword(userModel.getPassword());
