    ...
    */
    ...
    public void initChannel() throws InvalidArgumentException, TransactionException {
        if (this.channel == null){
            this.client.setUserContext(this.org.getUser(this.org.getUsername()));
    ...
    public Map<String, String> createChannel() throws InvalidArgumentException, IOException, TransactionException {
        this.client.setUserContext(this.org.getUser(this.org.getUsername()));//"Admin"
...
//        new File("./channel-artifacts/"+this.channelName + ".tx")
        ...
        for (int i = 0; i < OrderersCount; i++) {
            ...
            if (i == 0){
                this.channel = this.client.newChannel(this.channelName, anOrderer, channelConfiguration, this.client.getChannelConfigurationSignature(channelConfiguration, this.org.getUser(this.org.getUsername())));//"Admin"
            }
     ...
     */
    public Map<String, String> queryBlockByTransactionID(String txID) throws InvalidArgumentException, ProposalException, IOException, JSONException {
     ...
     */
    public Map<String, String> queryBlockByNumber(long blockNumber) throws InvalidArgumentException, ProposalException, IOException, JSONException {
     ...
     * 查询当前区块信息
     */
    public Map<String, String> queryCurrentBlockInfo() throws InvalidArgumentException, ProposalException, JSONException {
     ...
     */
    private Map<String, String> execBlockInfo(BlockInfo blockInfo) throws IOException, InvalidArgumentException, JSONException {
