 ...
 */
// const BaseUrl = "evtp-app-blockchain"
const BaseUrl = ""
$(function () {
    ...
    $("#save").click(function () {
        ...
        $.post(BaseUrl + "/save", {"jsonParam": jsonParam}, function (data) {
    ...
    $("#functionOp button").click(function () {
        ...
        switch (selectId) {
            ...
            case "getAccountHistory":
                $("#dataRequest").val('{"fcn":"getAccountHistory","args":["a"]}');
                $("#regionRequest").show();
                break;
            case "invoke":
                $("#dataRequest").val('{"fcn":"transferAccounts","args":["b","a","50"]}');
                $("#regionRequest").show();
                break;
            case "query":
                $("#dataRequest").val('{"fcn":"queryAccount","args":["a"]}');
                $("#regionRequest").show();
                break;
    ...
    $("#run").click(function () {
        ...
        switch (selectId) {
            case "createChannel":
                $.post(BaseUrl + "/chainchannel/createChannel", {}, function (jsonData) {
                ...
                break;
            case "joinPeer":
                $.post(BaseUrl + "/chainchannel/joinPeer", {}, function (jsonData) {
                    $("#dataResponse").val(JSON.stringify(jsonData));
                    $("#loading").hide();
                    $("#run,#systemOp").css("cursor", "default");
                    if (jsonData.status == 200) {
                ...
                break;
            case "install":
                $.post(BaseUrl + "/chaincode/install", {}, function (jsonData) {
                    $("#dataResponse").val(JSON.stringify(jsonData));
                    $("#loading").hide();
                    $("#run,#systemOp").css("cursor", "default");
                    if (jsonData.status == 200) {
            ...
            case "instantiate":
                ...
                $.ajax({
                    url: BaseUrl + '/chaincode/instantiate',
                    type: 'POST',
                    dataType: 'json',
            ...
            case "queryBlockByTransactionID":
                ...
                $.ajax({
                    url: BaseUrl + '/chainblock/queryBlockByTransactionID',
                    type: 'POST',
                    dataType: 'json',
                    contentType: 'application/json',
                    data: strParam,
            ...
            case "queryBlockByHash":
                ...
                $.ajax({
                    url: BaseUrl + '/chainblock/queryBlockByHash',
                    type: 'POST',
                    dataType: 'json',
                    contentType: 'application/json',
                    data: strParam,
            ...
            case "queryBlockByNumber":
                ...
                $.ajax({
                    url: BaseUrl + '/chainblock/queryBlockByNumber',
                    type: 'POST',
                    dataType: 'json',
                    contentType: 'application/json',
                    data: strParam,
                ...
                break;
            case "queryCurrentBlockInfo":
                $.post(BaseUrl + "/chainblock/queryCurrentBlockInfo", {}, function (jsonData) {
                    $("#dataResponse").val(JSON.stringify(jsonData));
                    $("#loading").hide();
                    $("#run,#systemOp").css("cursor", "default");
                    if (jsonData.status == 200) {
    ...
    $("#modify-pw").click(function () {
        ...
        $.post(BaseUrl + "/modifypassword", {"account": account, "password": password}, function (data) {
            var jsonData = eval("(" + data + ")");
            if (jsonData.result > 0) {
                alert("密码修改成功");
            }
