...
type EncryptedOfferList struct {
	Id                string           `json:"id"`
	EncryptedOfferArr []EncryptedOffer `json:"encrypted_offer_arr"`
	Flag              string           `json:"flag"`
	Time              string           `json:"time"`
}
type AuthenticOffer struct {
	Id     string `json:"id"`
	Number string `json:"number"`
	Price  string `json:"price"`
	Status string `json:"status"`
...
type AuthenticOfferList struct {
	Id                 string           `json:"id"`
	AuthenticOfferrArr []AuthenticOffer `json:"authentic_offerr_arr"`
	Flag               string           `json:"flag"`
	Time               string           `json:"time"`
}
...
type QualifiedOfferList struct {
	Id                string           `json:"id"`
	QualifiedOfferArr []QualifiedOffer `json:"qualified_offer_arr"`
	Flag              string           `json:"flag"`
	Time              string           `json:"time"`
}
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	} else if function == "addEncryptedOffer" {
		return addEncryptedOffer(stub, args)
	} else if function == "addAuthenticOffer" {
		return addAuthenticOffer(stub, args)
	} else if function == "verificationOffer" {
		return verificationOffer(stub, args)
	} else if function == "getQualifiedOfferList" {
